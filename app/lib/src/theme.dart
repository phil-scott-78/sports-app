...
abstract final class T {
  ...
  static const ghost = Color(0xFF3D434D); // below-faint: unplayed/inapplicable cells
  ...
  static const serveBall = Color(0xFFC9E04A); // tennis-ball chartreuse: serve dot, SET/BREAK POINT

  // ---- muted glyph fills (§2): high-frequency classification dots ----
  static const mutedGood = Color(0xFF2F6B3F); // ball / safe / positive fill
  static const mutedGoodGlyph = Color(0xFFC9E5CF);
  static const mutedBad = Color(0xFF7A3038); // strike / out / negative fill
  static const mutedBadGlyph = Color(0xFFF0CDD1);
  static const mutedNeutral = Color(0xFF6B5B2A); // foul / caution fill
  static const mutedNeutralGlyph = Color(0xFFEADFB8);
